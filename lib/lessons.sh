...
get_course_name() {
    ...
    case "$slug" in
        ...
        data-forging)      echo "Data Forging" ;;
        cicd-pipelines)    echo "CI/CD Pipelines" ;;
        kubernetes)        echo "Kubernetes & Container Orchestration" ;;
        terraform-iac)     echo "Terraform & Infrastructure as Code" ;;
        *) echo "$slug" ;;
    esac
}
